...
const PRODUCT_ICONS_FIXTURE = [
    "product-advertise-color",
    "product-audience-color",
    "product-benchmark-color",
    "product-consumer-research-color",
    "product-engage-color",
    "product-influence-color",
    "product-listen-color",
    "product-measure-color",
    "product-publish-color",
...
const renderNestedMenu = ({ slot, target }) => renderControlledMenu({
    ...
    target,
    content: x `
      <bds-menu slot="content" role="navigation" aria-label="Brandwatch Suite">
        <bds-menu-section>
        ...
        target: x `
                  <bds-menu-button-item
                    slot="target"
                    icon-start=${PRODUCT_ICONS_FIXTURE[id % PRODUCT_ICONS_FIXTURE.length]}
                    ...
                    <bds-menu-section>
                      ${c(Array.from({ length: 15 }, (_item, i) => i), (id) => id, (id) => x `
                          <bds-tooltip placement="top-start">
                            <bds-menu-button-item slot="target">
                              Sub button ${id + 1}
                            </bds-menu-button-item>
...
const renderShell = ({ renderMenu, renderHeader, renderMain }) => x `
  <bds-shell>
    ${renderGlobalNav()}
    <bds-app-outlet slot="app-outlet" name="Demo">
...
const renderApp = () => renderShell({
    renderMenu: () => x `
      <bds-menu slot="menu" role="navigation" aria-label="Demo">
        <bds-menu-section>
        ...
        <bds-menu-section label="Reports">
          ...
          <bds-menu-button-item>
            My reports
            <bds-lozenge slot="status-start" variant="positive">
              New
            </bds-lozenge>
            <bds-formatted-number
              slot="status-end"
        ...
        <bds-menu-section label="Fruit">
          ${c$4(actionsFixture, (item) => x `
              <bds-menu-button-item> ${item.name} </bds-menu-button-item>
            `)}
        </bds-menu-section>
      </bds-menu>
    `,
    renderHeader: () => x `
      <header slot="header" class="demo-header">
        <div class="start">
          <bds-button-group>
            <bds-icon-button
              variant="regular-subtle"
