 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const t$5={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},e$5=t=>(...e)=>({_$litDirective$:t,values:e});class i$5{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i;}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
class s$5 extends Event{constructor(s,t,e){super("context-request",{bubbles:!0,composed:!0}),this.context=s,this.callback=t,this.subscribe=e??!1;}}
...
class MenuButtonItem extends MenuItemMixin(ContextOpenMixin(BaseMixin(s$8))) {
     ...
     * This will only happen if the original event was not cancelled.
     */
    async dispatchMenuButtonClick(originalEvent) {
        /**
         * Defer until the original event has finished bubbling,
         * so we can check if it was cancelled
         */
        await Promise.resolve();
